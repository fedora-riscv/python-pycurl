...
# fix a use after free issue with unicode FORM_BUFFERPTR (#1277488)
Patch2:         pycurl-7.19.5.1-post-free.patch
...
%changelog
* Tue Nov 03 2015 Kamil Dudka <kdudka@redhat.com> - 7.19.5.1-4
- fix a use after free issue with unicode FORM_BUFFERPTR (#1277488)
